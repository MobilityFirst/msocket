...
package edu.umass.cs.msocket.test.gnstests;
...
{
  private static final String SOCKET_HRN = "msocket.junit.behindNAT11";
  ...
  private class EchoServerThread extends Thread
  {
    ...
    public void run()
    {
      ...
      {
        log.severe("MServerSocket side error"+ e.getMessage());
